# ALIENX — Client‑Side EVTX Companion

![](https://miro.medium.com/v2/resize:fit:4800/format:webp/1*baIkQcUohn7SJl9ULbBUcw.png)

ALIENX is a browser-based Windows Event Log analyzer that stays entirely on your machine. Load EVTX files, run curated SIGMA detections, correlate activity into storylines, extract IOCs, and export findings—without sending logs anywhere. If you are interested in contributing, feel free to check out the [guidelines](https://github.com/Koifman/ALIENX/blob/main/CONTRIBUTING.md).
...
```bash
git clone --recurse-submodules https://github.com/Koifman/ALIENX.git
cd ALIENX
npm install
...
ALIENX is designed for privacy-first, client-side analysis of small-to-medium log files. For a comprehensive overview of limitations, constraints, and design trade-offs, see [LIMITATIONS.md](LIMITATIONS.md).

Key constraints:

- Maximum file size: 1GB per file
- Optimal performance: Up to ~25k events
- Browser-only processing (no server backend)
...
If you enjoyed ALIENX - feel free to [support](https://ko-fi.com/koifsec) the work!
